...
class TicTacToe {
    ...
    init() {
        ...
        this.updateStatus("Your turn! Place a ❤️ to begin");
    }
    ...
    checkResult() {
        ...
        if (roundWon) {
            ...
            if (winner === 'heart') {
                this.updateStatus("🎉 You won! Your gift is ready!");
                ...
                this.updateStatus("So close! Try again — hint: three corners wins 💪");
                this.gameActive = false;
            }
            return;
        }
        ...
        if (roundDraw) {
            this.updateStatus("It's a draw! Play again 🤝");
            this.gameActive = false;
            return;
        }
